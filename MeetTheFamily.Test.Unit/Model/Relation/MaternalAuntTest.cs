...
namespace MeetTheFamily.Test.Unit.Model.Relation
{
    ...
    public class MaternalAuntTest
    {
        ...
        public void SetUp()
        {
            _subject = new MaternalAunt(_sister.Object, _cache.Object);
        }
        ...
        [TestMethod]
        public void FindMethodReturnNoneMessageWhenNoMaternalAunts()
        {
            //Arrange
            var name = "Kiran";
        ...
        [TestMethod]
        public void FindMethodReturnMaternalAunts()
        {
            //Arrange
            var name = "Kiran";
            var member = new Member(name, Gender.Male, "father", "mother");
            ...
            _cache.Setup(c => c.Search(name))
                .Returns(member);
            _sister.Setup(s => s.Find(member.Mother))
                .Returns(new string[] { "MaternalAunt" });
            ...
            //Assert
            Assert.AreEqual(1, output.Length);
            Assert.AreEqual("MaternalAunt", output[0]);
        }
    }
}
